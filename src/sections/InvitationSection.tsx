        ...
        >
          ...
          <div ref={bodyRef} className="space-y-6">
            ...
            <div className="inv-para" style={{ opacity: 0 }}>
              ...
              >
                {t(
                  'С огромной радостью приглашаем вас разделить с нами один из самых важных дней в нашей жизни — торжество Кыз Узаттуу нашей дорогой Алины.',
                  'Биздин жашообуздагы эң маанилүү күндөрдүн бири — Алинанын Кыз Узаттуу тоюн биз менен бөлүшүүгө чын жүрөктөн чакырабыз.'
                )}
              </p>
            </div>
