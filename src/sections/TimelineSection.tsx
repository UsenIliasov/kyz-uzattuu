...
export default function TimelineSection({ t }: TimelineSectionProps) {
  ...
  const events: TimelineEvent[] = [
    { time: '17:30', ru: 'Сбор гостей', kg: 'Коноктордун чогулушу' },
    { time: '18:00', ru: 'Торжественная часть', kg: 'Салтанаттуу бөлүк' },
    { time: '19:00', ru: 'Ужин', kg: 'Тамактануу' },
    { time: '20:30', ru: 'Танцы и веселье', kg: 'Бий жана көңүл ачуу' },
    { time: '23:00', ru: 'Завершение вечера', kg: 'Кечени жыйынтыктоо' },
  ];
