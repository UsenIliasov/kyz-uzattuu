              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-body mt-1" style={{ color: '#2C2421', fontSize: '0.9rem', opacity: 0.7, lineHeight: 1.6 }}>
                    {t(
                      'Мы будем рады, если вы добавите аксессуары или элементы в образе в современном этно-стиле',
                      'Биз сиздин заманбап этно стилдеги кийимиңизге бир нече аксессуарларды же элементтерди кошсоңуз абдан кубанычта болмокпуз.'
                    )}
                  </p>
                </div>
              </div>
